...
const EP1 = {
  ...
  body: [
    ...
    '지난 여름 부트캠프에서는 순서를 바꿔 봤습니다. 30개가 넘는 제주 기업에서 실제 문제를 받아 오고, 학생이 자기 전공에 맞는 문제를 직접 골랐습니다. 구글과 업스테이지 전문가가 AI 쓰는 법을 도왔고, 나온 답은 학생이 직접 분석하고 이해해서 마지막 판단까지 했습니다. 참여 학생의 70%가 컴퓨터·AI 전공이 아니었습니다.', '',
  ...
  kakao: [
    ...
    '지난 여름 부트캠프에서는 30개가 넘는 제주 기업에서 실제 문제를 받아 와, 학생이 문제를 고르고 AI가 낸 답을 직접 분석해 마지막 판단까지 하게 했습니다. 공대가 붙들어야 할 담론이 여기 있다고 보고 나섰습니다.', '',
    '{개인화}', '',
    '답장은 안 하셔도 됩니다. — 변영철',
  ].join('\n'),
  seg: {
