...
const EP1 = {
  ...
  body: [
    ...
    '이 부트캠프는 제주대학교 AI융합원의 AI 부트캠프사업단이 맡고 있습니다. 공과대학을 포함해 우리 대학 15개 학과가 참여하고, 에너지·우주·바이오·관광·해양·스마트시티·스마트팜 같은 제주 특화산업에 쓸 AX(AI 전환) 인재를 길러 내는 것이 목표입니다.', '',
    '지난 여름 부트캠프에서는 순서를 바꿔 봤습니다. 30개가 넘는 제주 기업에서 실제 문제를 받아 오고, 학생이 자기 전공에 맞는 문제를 직접 골랐습니다. 구글과 업스테이지 전문가가 AI 쓰는 법을 도왔고, 나온 답은 학생이 직접 분석하고 이해해서 마지막 판단까지 했습니다. 참여 학생의 70%가 컴퓨터·AI 전공이 아니었습니다. 전기·전자·통신처럼 전공이 제각각인 학생들이 각자 자기 문제를 들고 와 풀어 내는 것을 보면서, AI가 이렇게 쉽게 도움이 되는구나 싶었습니다.', '',
  ...
  kakao: [
    ...
    '더 걱정스러운 건 학생이 과제를 이해도 못 한 채 AI에 돌려 내는 일입니다. 학생이 배달부가 되어 버렸습니다.', '',
    '이 부트캠프는 제주대 AI융합원이 맡고 있고, 우리 대학 15개 학과가 참여해 제주 특화산업에 쓸 AX(AI 전환) 인재를 길러 내는 사업입니다.', '',
    '지난 여름 부트캠프에서는 30개가 넘는 제주 기업에서 실제 문제를 받아 와, 학생이 문제를 고르고 AI가 낸 답을 직접 분석해 마지막 판단까지 하게 했습니다. 전기·전자·통신처럼 전공이 제각각인 학생들이 각자 자기 문제를 들고 와 풀어 내는 것을 보면서, AI가 이렇게 쉽게 도움이 되는구나 싶었습니다. 공대가 붙들어야 할 담론이 여기 있다고 보고 나섰습니다.', '',
    '{개인화}', '',
    '답장은 안 하셔도 됩니다. — 변영철',
  ].join('\n'),
  seg: {
